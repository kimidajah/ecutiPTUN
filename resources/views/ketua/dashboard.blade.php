...
@php
    ...
    $pendingCuti = Cuti::where('status', 'disetujui_hr')->count(); // Menunggu approval ketua
    $approvedCuti = Cuti::where('status', 'disetujui_ketua')->orWhere('status', 'disetujui_pimpinan')->count();
    ...
    <div class="col-md-6 mb-3">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body">
                ...
                <canvas id="ketuaCutiStatusChart"></canvas>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 mb-3">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body">
                ...
                <canvas id="ketuaCutiBarChart"></canvas>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const ketuaCutiStatusCtx = document.getElementById('ketuaCutiStatusChart').getContext('2d');
    new Chart(ketuaCutiStatusCtx, {
        type: 'doughnut',
        data: {
    ...
    const ketuaCutiBarCtx = document.getElementById('ketuaCutiBarChart').getContext('2d');
    new Chart(ketuaCutiBarCtx, {
        type: 'bar',
        data: {
            labels: ['Pending', 'Disetujui', 'Ditolak'],
            datasets: [{
